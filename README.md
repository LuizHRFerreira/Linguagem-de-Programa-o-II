# Linguagem de Programação II - Atividades

Este repositório contém as atividades desenvolvidas durante a disciplina de **Linguagem de Programação II**, ministrada pelo professor **Lucas Nadalete**. Todas as atividades foram implementadas em **Java puro**, com foco no desenvolvimento de habilidades fundamentais da linguagem e aplicação de conceitos da programação orientada a objetos.
...
Curso de: Banco de dados - 3º Semestre

## 📌 Observações
Este repositório será atualizado ao longo do semestre conforme novas atividades forem propostas.
